...
export const metadata: Metadata = {
  title: "About Us",
  description:
    "Founded by a former small-business owner tired of overpriced distribution. Infinite Distribution delivers Melbourne letterbox flyers at maximum impact, minimum cost — meet the team and our mission.",
  alternates: { canonical: "/about" },
  openGraph: {
    type: "website",
    locale: "en_AU",
    siteName: "Infinite Distribution",
    title: "About Us | Infinite Distribution",
    description:

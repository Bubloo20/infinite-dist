...
export const metadata: Metadata = {
  ...
  description:
    "The terms of Infinite Distributions' On-Time Delivery Promise: if we miss an agreed delivery deadline for reasons within our control, your delivery is free. Eligibility, exclusions and refund details.",
  alternates: { canonical: "/guarantee-terms" },
  openGraph: {
    type: "website",
    locale: "en_AU",
    siteName: "Infinite Distributions",
    title: "On-Time Delivery Promise — Terms & Conditions | Infinite Distributions",
    description:
